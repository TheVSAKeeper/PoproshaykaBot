...
namespace TwitchLib.Api.Test.Unit.Helix
{
    public class HelixAnalytics
    {
        ...
        public async void TestGetGameAnalytics()
        {
            ...
            var result = await api.Helix.Analytics.GetGameAnalyticsAsync("493057", accessToken: "RandomTokenThatDoesntMatter");
        ...
        public async void TestGetExtensionAnalytics()
        {
            ...
            var result = await api.Helix.Analytics.GetExtensionAnalyticsAsync("abcdefgh", accessToken: "RandomTokenThatDoesntMatter");
