...
internal sealed record HelixGlobalBadgesResponse(
    [property: JsonPropertyName("data")] IReadOnlyList<HelixGlobalBadgeDto>? Data);
...
internal sealed record HelixGlobalEmotesResponse(
    [property: JsonPropertyName("data")] IReadOnlyList<HelixGlobalEmoteDto>? Data);

internal sealed record HelixGlobalEmoteDto(
    [property: JsonPropertyName("id")] string Id,
    [property: JsonPropertyName("name")] string Name,
    [property: JsonPropertyName("images")] HelixGlobalEmoteImagesDto? Images,
